...
namespace GWCU_USSD_WebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LoginAdmin(AdminUserViewModel model){
        ...
        public bool IsLoginValid(string username, string password, string secretKey)
        {
